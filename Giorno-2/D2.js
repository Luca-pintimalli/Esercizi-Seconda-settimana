...
if (numero1 === 8 || numero2 === 8 || numero1 + numero2 === 8 || numero1 - numero2 === 8 || numero2 - numero1 === 8) {
    console.log("Condizione verificata: almeno uno dei numeri è 8 o la loro somma/sottrazione è uguale a 8.");
} else {
...
skills.pop();
console.log(me);
document.getElementById("prova").innerHTML = me
...
console.log(numeri) ;
document.getElementById("prova").innerHTML = numeri ;
